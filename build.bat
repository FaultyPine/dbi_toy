...
"%CLANG%" main.c -o %BUILD%/main.exe -g
if errorlevel 1 goto :fail

"%CLANG%" "%DYNASM_INJECTION_C%" -o %BUILD%/injection.dll -g -shared %ZydisArgs% %DynasmArgs%
if errorlevel 1 goto :fail

"%CLANG%" tester.c -o %BUILD%/tester.exe -g -luser32
if errorlevel 1 goto :fail
